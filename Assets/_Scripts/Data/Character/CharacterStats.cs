...
namespace Data
{
    ...
    {
        public FixedFloat WalkSpeed;

        public FixedFloat Traction;

        public FixedFloat InitialDashSpeed;

        public FixedFloat DashAcceleration;

        public int DashFrames;

        public FixedFloat RunningSpeed;

        public FixedFloat NormalJumpForce;

        public FixedFloat ShortJumpForce;

        public FixedFloat AirJumpForce;
        ...
        public FixedFloat AirSpeed;

        public FixedFloat AirAcceleration;
